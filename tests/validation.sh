...
cssout=$(curl -s -F output=gnu -F "text=<../css/style.css" https://jigsaw.w3.org/css-validator/validator)

htmlout=$(curl -s -F out=gnu -F "content=<../index.html" https://validator.nu/)
